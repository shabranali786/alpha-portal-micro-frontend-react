                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2">
                        ...
                        {/* Warning about associated brands */}
                        {unit?.brands_count &&
                          parseInt(unit.brands_count) > 0 && (
                            <div className="mt-3 rounded-lg border border-yellow-200 bg-yellow-50 p-3 dark:border-yellow-700/40 dark:bg-yellow-900/20">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium text-yellow-800 dark:text-yellow-200">
                                  Warning: This unit has {unit.brands_count}{" "}
                                  associated brands
                                </span>
                              </div>
                              <p className="mt-1 text-xs text-yellow-700 dark:text-yellow-200/80">
                                Deleting this unit may affect the associated
                                brands. Please ensure all dependencies are
                                handled properly.
                              </p>
                            </div>
                          )}
