...
export default function DeleteExternalPaymentModal({
  open,
  onClose,
  invoice,
  onConfirm,
                ...
                <div className="px-6 py-5">
                  <div className="flex items-center gap-4">
                    <div className="flex-shrink-0">
                      <div className="size-12 bg-red-100 rounded-full flex items-center justify-center dark:bg-red-500/15">
                        <svg
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mt-1 dark:text-slate-400">
                        Are you sure you want to delete external payment{" "}
                        <strong>
                          {invoice?.invoice_number || invoice?.invoice_no}
                        </strong>{" "}
                        for{" "}
                        <strong>
                          {invoice?.lead?.name || invoice?.customer_name}
                        </strong>
                  ...
                  <div className="flex items-center justify-end gap-3 mt-6">
                    ...
                    <button
                      ...
                      disabled={loading}
                    >
                      {loading ? "Deleting..." : "Delete External Payment"}
                    </button>
                  </div>
                </div>
              </DialogPanel>
