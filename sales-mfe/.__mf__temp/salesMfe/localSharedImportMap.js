...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@headlessui/react": async () => {
          let pkg = await import("__mf__virtual/salesMfe__prebuild___mf_0_headlessui_mf_1_react__prebuild__.js");
            return pkg;
        }
      ,
        "@reduxjs/toolkit": async () => {
          let pkg = await import("__mf__virtual/salesMfe__prebuild___mf_0_reduxjs_mf_1_toolkit__prebuild__.js");
            return pkg;
        }
      ,
        "axios": async () => {
          let pkg = await import("__mf__virtual/salesMfe__prebuild__axios__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
          let pkg = await import("__mf__virtual/salesMfe__prebuild__react__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/salesMfe__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ,
        "react-hot-toast": async () => {
          let pkg = await import("__mf__virtual/salesMfe__prebuild__react_mf_2_hot_mf_2_toast__prebuild__.js");
            return pkg;
        }
      ,
        "react-redux": async () => {
          let pkg = await import("__mf__virtual/salesMfe__prebuild__react_mf_2_redux__prebuild__.js");
            return pkg;
        }
      ,
        "react-router-dom": async () => {
          let pkg = await import("__mf__virtual/salesMfe__prebuild__react_mf_2_router_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ,
        "react-select": async () => {
          let pkg = await import("__mf__virtual/salesMfe__prebuild__react_mf_2_select__prebuild__.js");
            return pkg;
        }
      ...
      const usedShared = {
        ...
        ,
          "react-select": {
            ...
            async get () {
              if (false) {
                throw new Error(`Shared module '${"react-select"}' must be provided by host`);
              }
              usedShared["react-select"].loaded = true
              const {"react-select": pkgDynamicImport} = importMap
              const res = await pkgDynamicImport()
              const exportModule = {...res}
              // All npm packages pre-built by vite will be converted to esm
              Object.defineProperty(exportModule, "__esModule", {
