...
// Team/Company/WebOrder Accordion Item
...
const TeamWiseReport = () => {
  ...
  // Get web orders data from teams array
  ...
  return (
    <div className="space-y-6">
      ...
      {/* All Teams List - Including Company Total, Web Orders, and Teams */}
      <div className="space-y-4">
        ...
        {loading ? (
          ...
          <>
            {/* Company Total */}
            {companyTotalData && (
              <TeamAccordionItem data={companyTotalData} type="company" />
            )}

            {/* Web Orders */}
            {webOrdersData && (
              <TeamAccordionItem data={webOrdersData} type="weborders" />
            )}
