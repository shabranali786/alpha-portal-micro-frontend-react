...
const UnitWiseReport = () => {
  ...
  if (loading && !reportData) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 dark:text-slate-400", children: "Loading unit report..." })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 md:flex-row md:items-center md:justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: "Unit Wise Report" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 dark:text-slate-400", children: reportData?.filter_date ? `Showing data for ${formatDate(reportData.filter_date)}` : "Review unit performance and financial metrics" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full lg:max-w-md relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-2 block text-sm font-medium text-gray-700 dark:text-slate-300", children: "Search units" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SearchBox,
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-dashed border-slate-300 bg-white p-8 text-center text-sm text-slate-500 dark:border-slate-700 dark:bg-slate-900/70 dark:text-slate-300", children: "Loading data…" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        companyTotalData && /* @__PURE__ */ jsxRuntimeExports.jsx(UnitAccordionItem, { data: companyTotalData, type: "company" }),
        webOrdersData && /* @__PURE__ */ jsxRuntimeExports.jsx(UnitAccordionItem, { data: webOrdersData, type: "weborders" }),
        filteredUnits.length > 0 ? filteredUnits.map((unitData, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          UnitAccordionItem,
          {
            data: unitData,
            type: "unit"
          },
          unitData.unit?.id || index
        )) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-dashed border-slate-300 bg-white p-8 text-center text-sm text-slate-500 dark:border-slate-700 dark:bg-slate-900/70 dark:text-slate-300", children: searchTerm ? "No units match your search criteria." : "No unit data available for the selected date." })
      ] })
    ] })
  ] });
};

export { UnitWiseReport as default };
