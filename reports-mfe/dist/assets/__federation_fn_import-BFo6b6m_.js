...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-c2ir1ihb.js', import.meta.url).href),import:true,requiredVersion:'^19.1.1'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-CE2Bz5FR.js', import.meta.url).href),import:true,requiredVersion:'^19.1.1'},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-DhYnvhvv.js', import.meta.url).href),import:true,requiredVersion:'^7.8.2'},'@reduxjs/toolkit':{get:()=>()=>__federation_import(new URL('__federation_shared_@reduxjs/toolkit-CX9JcfTG.js', import.meta.url).href),import:true},'react-redux':{get:()=>()=>__federation_import(new URL('__federation_shared_react-redux-BDRaYLxJ.js', import.meta.url).href),import:true},'axios':{get:()=>()=>__federation_import(new URL('__federation_shared_axios-2arYIwGz.js', import.meta.url).href),import:true},'react-hot-toast':{get:()=>()=>__federation_import(new URL('__federation_shared_react-hot-toast-CVqWc7nd.js', import.meta.url).href),import:true},'socket.io-client':{get:()=>()=>__federation_import(new URL('__federation_shared_socket.io-client-BWAxUuUq.js', import.meta.url).href),import:true}};
