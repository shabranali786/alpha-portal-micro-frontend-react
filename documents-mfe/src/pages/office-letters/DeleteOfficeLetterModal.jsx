// pages/office-letters/DeleteOfficeLetterModal.js
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <DialogTitle className="text-lg font-semibold text-gray-900 dark:text-slate-100">
                        Delete Office Letter
                      </DialogTitle>
                      <div className="mt-2">
                        <p className="text-sm text-gray-600 dark:text-slate-400">
                          Are you sure you want to delete office letter{" "}
                          <strong className="text-gray-900 dark:text-slate-100">
                            {officeLetter?.serial_number}
                          </strong>
                          ?
                        </p>
...
export default DeleteOfficeLetterModal;
